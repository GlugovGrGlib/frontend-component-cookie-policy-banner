...
import { SPANISH_IETF_TAG, ENGLISH_IETF_TAG, DANISH_LANGUAGE_CODE } from '../constants';
...
const policyText = {
  ...
  [DANISH_LANGUAGE_CODE]: 'We\'ve updated our <a href="https://edx.org/edx-privacy-policy" class="policy-link" target = "_blank">Privacy Policy</a> to better reflect how we collect, use and share your data.',
};
storiesOf('Cookie Policy Banner', CookiePolicyBanner)
  ...
  .add('languageCode "en" override', () => (<CookiePolicyBanner languageCode="da" />))
  .add('languageCode "en" overridden policy text', () => (<CookiePolicyBanner policyText={policyText} languageCode="da" />))
